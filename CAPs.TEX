...
\section{Diseño del agente inteligente}
...
\subsection{Diagrama de flujo del diseño del agente inteligente}

Luego de comparar y seleccionar tanto el sensor, actuador y los algoritmos del programa del agente inteligente recopilamos los resultados y estructuramos el siguiente diagrama de flujo:

\begin{figure}[ht]
\begin{center}
\includegraphics[width=0.9\textwidth]{diagrama2}
\end{center}
\begin{center}
\vskip -0.5cm
\caption{\small{Diagrama de flujo del agente inteligente.}}
{\small{Fuente: Elaboración propia.}}
\end{center}
\end{figure}
