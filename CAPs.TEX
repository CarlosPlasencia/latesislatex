...
A través del diseño de un agente inteligente se reconoce expresiones faciales en secuencias dinámicas de imágenes.
...
\begin{enumerate}
\item[a)] Recopilar información acerca del diseño de un agente inteligente aplicado al reconocimiento de expresiones faciales en secuencia dinámica de imágenes.

\item[b)] Elaboración de la arquitectura del agente inteligente para reconocimiento de expresiones faciales en secuencia dinámica de imágenes mediante las especificaciones del entorno de trabajo (PEAS).

\item[c)] Comparar y analizar cada componente de la estructura del agente inteligente haciendo uso de una matriz de confusión.

\item[d)] Elaborar el diseño de un agente inteligente basado en las evaluaciones de los componentes seleccionados.

\item[e)] Alcanzar un tasa de sensibilidad del agente inteligente mayor al 90% 

\item[f)] Alcanzar un tasa de especificidad del agente inteligente mayor al 95%

\item[g)] Alcanzar un tasa de precisión del agente inteligente mayor al 90%
\end{enumerate}


\section{Estructura de la tesis}

El presente trabajo está dividido en 5 capítulos. El primer capítulo presenta los aspectos generales del tema tratado: Justificación de la investigación, La formulación del problema, Elaboración de la hipótesis, los objetivos, la contribución, además de la estructura de la tesis.

En el capítulo dos se presenta el Marco teórico, se describen los conceptos y teorías fundamentales para la comprensión y desarrollo del presente trabajo, los mismos que nos otorgaron una visión completa de los temas abordados en la investigación. 

En el tercer capítulo trata del tema central de la tesis donde se desarrollaron los métodos y se seleccionaron las técnicas adecuadas para el diseño del agente inteligente de reconocimiento expresiones faciales. 

En el cuarto capítulo se plasman los resultados obtenidos, es decir los valores de los indicadores propuestos para la investigación, los mismo que nos permiten llegar a nuestras conclusiones, para finalizar tenemos las referencias bibliográficas consultadas y el apéndice.

En el quinto capítulo se presentan las consideraciones finales obtenidas en esta tesis. Inicialmente se presentan las conclusiones, seguidas de las recomendaciones para futuras investigaciones relacionadas al tema.

Finalmente, se describen las referencias bibliográficas usadas para la investigación usadas en esta tesis y los anexos donde se presentan el cuadro de resultados utilizados en fase prueba, interfaces del agente inteligente.
...
por lo tanto n = 349 secuencias dinámicas de imágenes.
...
\subsection{Análisis PEAS}
Primero analizaremos el entorno en el cual trabajara nuestro agente inteligente, para esto identificamos cada uno de los elementos del PEAS (Performance, Entorno, Actuadores y Sensores) visto en el capítulo anterior (2.2.2).
